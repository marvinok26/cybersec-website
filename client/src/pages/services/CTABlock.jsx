        ...
        <div className="tf-container mx-auto px-4">
          <div className="flex flex-wrap items-center">
            ...
            <div className="w-full md:w-7/12 mb-8 md:mb-0">
              <div className="heading-title space-y-4 max-w-[600px]">
            ...
            <div className="w-full md:w-5/12 mt-8 md:mt-0 relative">
              <div className="relative">
                ...
                {/* Quote Feature */}
                {isInView && (
                  <div className="absolute left-1/2 transform -translate-x-1/2 -translate-y-[50%] bg-[#2DB1A3] p-4 rounded-lg shadow-lg text-center w-[323px] z-10">
                    <div className="counter text-4xl font-bold text-white">
                      25 +
                    </div>
